...
namespace milk {
    ...
    template <typename _type> struct basic_stream<_type, mdd_io> {
        detail::stream_putfn_t<_type> put;
        detail::stream_getfn_t<_type> get;
        detail::stream_writefn_t<_type> write;
    };
    ...
    auto serial_console = basic_iostream<char>{drivers::serial::uart::write_byte,
                                               drivers::serial::uart::read_byte<char>, drivers::serial::uart::write};
} // namespace milk